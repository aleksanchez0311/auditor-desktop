...
public final class IncomesOperGestion extends OperationsGestion {

    public IncomesOperGestion(JFrame parent, boolean lockParent, OperationsCRUD operationsCRUD, ItemsCRUD itemsCRUD, boolean isIncomeForm) {
        super(parent, lockParent, operationsCRUD, itemsCRUD, isIncomeForm, operationsCRUD.getIncomeOperationsList(), Setup.CATEGORIA_MATERIA_PRIMA);
    ...
    protected void refreshFrameView() throws SQLException {
        ...
        operations = operationsCRUD.getIncomeOperationsList();
    ...
    protected void save() {
        try {
            Item selectItem = checker.getSelectedItem();
            ...
            Operation newOperation = new Operation(selectItem, atStartOfDay, ammount, value, isIncome, isBilled, isOpening);
