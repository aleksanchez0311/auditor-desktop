...
public class OutcomesOperGestion extends OperationsGestion {

    public OutcomesOperGestion(JFrame parent, boolean lockParent, OperationsCRUD operationsCRUD, ItemsCRUD itemsCRUD, boolean isIncomeForm) {
        super(parent, lockParent, operationsCRUD, itemsCRUD, isIncomeForm, operationsCRUD.getOutcomeOperationsList(), Setup.CATEGORIA_MATERIA_PRIMA);
    ...
    protected void refreshFrameView() throws SQLException {
        ...
        operations = operationsCRUD.getOutcomeOperationsList();
    ...
    protected void save() {
        try {
            ...
            Instant atMorningOfDay = new Timing(dcDateValue.getDate()).atMorningOfDay();
            ...
            Operation newOperation = new Operation(selectedItem, atMorningOfDay, ammount, value, isIncome, isBilled, isOpening);
    ...
    protected void update() {
        try {
            ...
            operation.setInstant(atMorningOfDay);
